...
/****** Object:  StoredProcedure [DBBackup].[usp_ExecuteBackup]    Script Date: 11/20/2018 11:31:47 AM ******/
...
create proc [DBBackup].[usp_ExecuteBackup]
...
BEGIN
    ...
    DECLARE @sqlstatement nvarchar(max) 
       ...
       SELECT @DBName = DBName
              ...
              -- comment because this calculate size allocated not the size effectived used by db

 

              --SELECT @DBSize = (convert(dec(15),sum(size))* 8192/ 1048576)/1024
              ...
              --     SELECT CONVERT(DECIMAL(18,2), SUM(size)*8/1024.0/1024.0)
              ...
              --     SELECT CONVERT(DECIMAL(18,2), SUM(total_pages)*8/1024.0/1024.0)
           ...
           --select @DBSizeOut
              ...
              --IF UPPER(@Period) = 'DAILY'

              --     set @CleanUpTime = 72

              --IF UPPER(@Period) = 'SYSDAILY'

              --    set @CleanUpTime = 168

              --IF UPPER(@Period) = 'WEEKLY'
