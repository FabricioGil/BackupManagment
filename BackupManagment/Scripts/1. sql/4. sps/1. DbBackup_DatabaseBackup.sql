...
/****** Object:  StoredProcedure [DBBackup].[DatabaseBackup]    Script Date: 11/13/2018 6:14:33 PM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
  ...
  IF EXISTS (SELECT * FROM sys.objects objects INNER JOIN sys.schemas schemas ON objects.[schema_id] = schemas.[schema_id] WHERE objects.[type] = 'P' AND schemas.[name] = 'Utility' AND objects.[name] = 'usp_Command_Execute' AND OBJECT_DEFINITION(objects.[object_id]) NOT LIKE '%@LockMessageSeverity%')
  BEGIN
    ...
    BEGIN
      ...
      BEGIN
        ...
        BEGIN
          ...
          EXECUTE @CurrentCommandOutput01 = [Utility].[usp_Command_Execute] @Command = @CurrentCommand01, @CommandType = @CurrentCommandType01, @Mode = 1, @DatabaseName = @CurrentDatabaseName, @LogToTable = @LogToTable, @Execute = @Execute
          SET @Error = @@ERROR
      ...
      BEGIN
        ...
        BEGIN
          ...
          EXECUTE @CurrentCommandOutput02 = [Utility].[usp_Command_Execute] @Command = @CurrentCommand02, @CommandType = @CurrentCommandType02, @Mode = 1, @DatabaseName = @CurrentDatabaseName, @LogToTable = @LogToTable, @Execute = @Execute
          SET @Error = @@ERROR
      ...
      BEGIN
        ...
        EXECUTE @CurrentCommandOutput03 = [Utility].[usp_Command_Execute] @Command = @CurrentCommand03, @CommandType = @CurrentCommandType03, @Mode = 1, @DatabaseName = @CurrentDatabaseName, @LogToTable = @LogToTable, @Execute = @Execute
        SET @Error = @@ERROR
      ...
      BEGIN
        ...
        BEGIN
          ...
          EXECUTE @CurrentCommandOutput04 = [Utility].[usp_Command_Execute] @Command = @CurrentCommand04, @CommandType = @CurrentCommandType04, @Mode = 1, @DatabaseName = @CurrentDatabaseName, @LogToTable = @LogToTable, @Execute = @Execute
          SET @Error = @@ERROR
      ...
      BEGIN
        ...
        BEGIN
          ...
          EXECUTE @CurrentCommandOutput05 = [Utility].[usp_Command_Execute] @Command = @CurrentCommand05, @CommandType = @CurrentCommandType05, @Mode = 1, @DatabaseName = @CurrentDatabaseName, @LogToTable = @LogToTable, @Execute = @Execute
          SET @Error = @@ERROR
