...
/****** Object:  Job [Maintenance.Backup.Daily]    Script Date: 6/12/2019 10:49:00 AM ******/
EXEC msdb.dbo.sp_delete_job @job_name=N'Maintenance.Backup.Daily', @delete_unused_schedule=1
GO
...
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 6/12/2019 10:49:00 AM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [set on]    Script Date: 6/12/2019 10:49:00 AM ******/
...
go', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Update DbConfig]    Script Date: 6/12/2019 10:49:00 AM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Update DbConfig', 
		@step_id=2, 
		@cmdexec_success_code=0, 
		@on_success_action=3, 
		...
		@retry_interval=0, 
		@os_run_priority=0, @subsystem=N'TSQL', 
		@command=N'EXEC [DBBackup].[usp_Config_Populate]', 
		@database_name=N'DbAdmin', 
		@flags=4
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Execute Backup Script]    Script Date: 6/12/2019 10:49:00 AM ******/
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [set off : success]    Script Date: 6/12/2019 10:49:00 AM ******/
...
go', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [set off : failure]    Script Date: 6/12/2019 10:49:00 AM ******/
